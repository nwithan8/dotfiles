...
# Override default (personal) settings with PaymentWorks-specific settings
REPO_LOCATION=$1
WORK_FOLDER="paymentworks"
...
# Add PaymentWorks-specific bashrc files to import list
echo "Adding PaymentWorks-specific bashrc files to import list..."
do_add_bashrc_import_groups "paymentworks"